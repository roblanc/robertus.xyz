...
1. Log in to the [Render dashboard](https://dashboard.render.com/) and click "New +" in the top left, then select "Static Site".
2. Select your Git provider and repository containing your Quartz project.
3. Under "Build Command", enter `npx quartz build`.
4. Under "Publish Directory", enter `public`.
5. Press "Create Static Site". Your site will be live on a `*.onrender.com` URL.
6. To add a custom domain, check the "Settings" tab for your service.

## Other Alternatives

While the services above are popular choices, any platform that can host static sites will work. Here are a few more to consider:

- **[Fly.io](https://fly.io/):** Known for deploying applications close to users globally. While powerful, it might be more complex than needed for a simple static site.
- **[Railway](https://railway.app/):** Offers a simple deployment experience similar to Render and Vercel.
- **[AWS Amplify](https://aws.amazon.com/amplify/):** Part of Amazon Web Services, providing a robust and scalable hosting solution.
- **[Firebase Hosting](https://firebase.google.com/docs/hosting):** Google's platform for hosting static and dynamic content.
