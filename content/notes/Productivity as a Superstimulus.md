...
[Man dies after 3-day internet gaming binge.](https://edition.cnn.com/2015/01/19/world/taiwan-gamer-death/index.html)[Influencer dies after binge drinking on livestream.](https://edition.cnn.com/2023/05/27/asia/chinese-livestreamer-drinking-baijiu-intl-hnk/index.html)Fast food is killing you slowly. It is surprising that we have ended up in this place, isn’t it?
...
[Mark Fischer](./Mark Fischer.md) writes:
...
+ Prompts used
    - faceless Gollum, poly 3D, mindlessly scrolling through a TikTok, beam of light coming out of the phone, wide shot, black background
    - Visualize from above the room, a faceless woman in a dimly lit room. She’s lying comfortably on a couch, engrossed in her phone. An array of bottles is scattered on her table, as well as fast food boxes, adding an element of intrigue to the scene. The image is to be rendered in a low-poly 3D style, captured in a wide shot to encompass the entire setting.
    - Visualize a faceless woman in a dimly lit room. She’s lying comfortably on a couch, engrossed in her phone. An array of bottles is scattered behind her, adding an element of intrigue to the scene. The image is to be rendered in a low-poly 3D style, captured in a wide shot to encompass the entire setting. ar 16:9
    - a figure of a faceless man, in a dark room, playing video games at his computer, the image is minimalistic, showing only the man, the desk, the computer, low poly 3d
    - a figure of a faceless woman, in a dark room, lying on the floor, filming herself with a camera, lots of bottles behind him, looking relaxed in a chair, low poly 3d, wide shot
    - a faceless figure immersed in the digital glow of his computer screen, engrossed in a video game. The scene is set in a dimly lit room, with the minimalistic design focusing solely on the man, his desk, and the computer. The image is to be rendered in a low-poly 3D style, emphasizing simplicity and abstraction
    - 
...
[Deel drie Het gemeenschapsleven van meeuwen, In 't vrije veld, Niko Tinbergen - DBNL](https://www.dbnl.org/tekst/tinb003intv01_01/tinb003intv01_01_0008.php)



+ #### **Tags**
+ ### **Titles**
    - Supernormal Stimuli: Are we amusing ourselves to death? 

    Certainly! Here are a few thumbnail ideas for a video titled "Supernormal Stimuli: Are we amusing ourselves to death?":

    1. **Visual Overload**: A pair of eyes with multiple colorful and flashy stimuli, such as social media icons, games, and TV screens, reflecting in the pupils, indicating sensory overload.
    2. **Balance Scale**: A traditional balance scale with one side holding symbols of modern entertainment (like a smartphone, TV, and gaming console) and the other side showing a brain, suggesting an imbalance.
    3. **Juxtaposition**: Half of the thumbnail shows a person deeply engrossed in multiple screens, while the other half shows the same person engaging in activities like reading, exercising, or spending time in nature.
    4. **Question Mark**: A person surrounded by various forms of entertainment, such as a smartphone, TV, and fast food, with a large question mark above their head, symbolizing introspection.
    5. **Hourglass**: An hourglass where the sand is made up of small icons representing entertainment (social media, video games, etc.), indicating time slipping away.

Would you like any of these ideas to be turned into an image?

- 
    - Superstimuli: Are we amusing ourselves to death?
    - Supernormal Stimuli is Ruining Your Health
    - How overstimulation is ruining your life 
    - Stimulating Ourselves to Death
    - Dying from Stimulation
    - The History of Superstimuli
    - Superstimuli and the Collapse of the World
    - Superstimuli: A View from Hell
    - Supernormal Stimuli: The Silent Saboteur of Your Well-being
    - Overstimulation Overload: Escaping the Clutches of a Hyper-Stimulated Life
    - Stimulating Ourselves to Extinction: The Dangerous Pursuit of Never-Ending Thrills
    - Dying for a Thrill: The Perils of Unbridled Stimulation
    - Unveiling the Dark Side of Superstimuli: From Pleasure to Pandemonium
    - Superstimuli Unleashed: The Explosive Impact on Your Mind and Body
    - The History of Superstimuli: From Temptation to Technological Tyranny
    - Superstimuli: Society's Siren Song or Catalyst for Catastrophe?
    - The Stimulation Epidemic: Are We Doomed to Self-Destruction?
    - Beyond Amusement: Superstimuli's Sinister Grip on Your Psyche
+ ### **Description**

    Supernormal stimuli are designed to elicit a disproportionate craving. In this video, we'll explore what supernormal stimuli are, how they affect us, and whether they're amusing us to death.

    Supernormal stimuli are artificial stimuli that are designed to be more appealing than natural stimuli. They are often exaggerated, simplified, or intensified versions of natural stimuli. For example, junk food is a supernormal stimulus because it is designed to be more appealing than natural food. It is high in sugar, fat, and salt, and it is often processed to make it more palatable.

    Supernormal stimuli can have a powerful effect on our behavior. They can trigger our reward system and make us crave them. This can lead to addiction and compulsive behaviors. For example, people who are addicted to junk food often find it difficult to control their cravings, even when they know that it is unhealthy.

    In this video, we'll explore the different types of supernormal stimuli, how they affect us, and whether they're amusing us to death. We'll also discuss how to protect ourselves from the negative effects of supernormal stimuli.

    This video discusses superstimuli, overstimulation, dopamine, social media addiction, internet addiction, and a variety of other issues. It’s also about self-improvement, productivity, and similar things.
...
[Amusing Ourselves to Death? Superstimuli and the Evolutionary Social Sciences by Andreas De Block, Bart Du Laing :: SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1500844)

[A world of difference: B.F. Skinner and The Good Life : Ambrose Video Publishing : Free Download, Borrow, and Streaming : Internet Archive](https://archive.org/details/bf-skinner-a-world-of-difference-bf-skinner-and-the-good-life-1979)

    - [The role of flow experience in cyber-game addiction - PubMed](https://pubmed.ncbi.nlm.nih.gov/14756934/)
    - [Edge.org](https://www.edge.org/response-detail/27203)
    - [The great challenge of the 21st century is learning to consume less. This is how we can do it](https://www.weforum.org/agenda/2018/05/our-future-depends-on-consuming-less-for-a-better-world/)
    - [Video game addict, 17, is found slumped dead on his computer in Thailand | Daily Mail Online](https://www.dailymail.co.uk/news/article-7650671/Video-game-addict-17-slumped-dead-computer-Thailand.html)
    - [The View from Hell: Trying to See Through: A Unified Theory of Nerddom](https://www.gwern.net/docs/philosophy/epistemology/2012-sistery-tryingtoseethrough.html)
    - [https://www.lesswrong.com/posts/Jq73GozjsuhdwMLEG/superstimuli-and-the-collapse-of-western-civilization](https://www.lesswrong.com/posts/Jq73GozjsuhdwMLEG/superstimuli-and-the-collapse-of-western-civilization)
    - [Amusing Ourselves to Death? · Gwern.net](https://www.gwern.net/Amuse)
    - [https://www.lesswrong.com/tag/adaptation-executors](https://www.lesswrong.com/tag/adaptation-executors)
    - [Man dies after 3-day Internet gaming binge - CNN](https://edition.cnn.com/2015/01/19/world/taiwan-gamer-death/index.html)
    - [15 People Who Have Died Playing Video Games](https://www.thegamer.com/15-people-who-have-died-playing-video-games/)
    - [Three day gaming binge kills Taiwanese man | KitGuru](https://www.kitguru.net/gaming/andrzej/three-day-gaming-binge-kills-taiwanese-man/)
    - [https://www.tandfonline.com/doi/abs/10.1080/09515089.2010.529048](https://www.tandfonline.com/doi/abs/10.1080/09515089.2010.529048)

    

Taiwan. Mr. H plays Diablo 3 in an internet cafe for 72 hours. Sleep deprivation, lack of proper hydration, food, no sunlight, exhaustion, superstimulation. Mr. H collapses motionless. A blood clot in his leg caused a heart attack.  Police said the gamers sitting in the cafe continued playing, thinking that Mr. H is simply taking a nap.

He was ultimately killed by a super-stimulus.

Online game addiction is a relatively new mental disorder, where people can't stop playing their favorite game due to various factors.
...
- ***Example 1***
    ...
    *--*Eliezer Yudkowsky,  S[::uperstimuli and the Collapse of Western Civilisation::](https://www.lesswrong.com/posts/Jq73GozjsuhdwMLEG/superstimuli-and-the-collapse-of-western-civilization)

    Now that we can get far more than we need with little effort, our evolved neediness serves us poorly, but there is no evolutionary mechanism to rid ourselves of these powerful desires, so we become fatter and fatter, along with the profits of fast food corporations.

- ***Example 2***

    Female firefly species mimic the light patterns of other firefly species' females, causing males from those other species to attempt to copulate with the deceptive females, who then eat them. *Source [https://philarchive.org/archive/ELHFFF](https://philarchive.org/archive/ELHFFF)*

- ***Example 3***
- A cow uses VR googles. Is this a bad thing?
- The things that animals have evolved to respond to in a particular way are referred to as normal stimuli. The normal responses of the animal are thrown off by the supranormal ones because they amplify the stimuli to which the animal has adapted to react.

## **Background**

In a famous set of studies done in the 1950s, biologist and ornithologist Niko Tinbergen created “supernormal stimuli,” simulacra of beaks and eggs and other biologically salient objects, that were painted, primped and blown up in size. In these studies herring gull chicks pecked more at big red knitting needles than at adult herring gull beaks, presumably because they were redder and longer than the actual beaks.
...
When Tinbergen’s student, Richard Dawkins made the dummy rounder and more pear shaped greater lust was inspired. He called these dummies “sex bombs.” Outside of the lab, male Australian jewel beetles have been recorded trying to perform sex with beer bottles made of shiny brown glass whose light reflections resemble the shape and color of female beetles.

Research on the evolution of signaling shows that animals frequently alter or exaggerate features to attract, mimic, intimidate, or protect themselves from conspecifics, sometimes setting off an arms race between deception and the detection of such deception. But it is only humans who engage in conscious manipulation of signals using cultural tools in real time rather than relying on slow genetic changes over evolutionary time. We live in Tinbergen’s world now, surrounded by supernormal signals produced by increasingly sophisticated cultural tools. We need only compare photoshopped images to the un-retouched originals, or compare, as my own studies have done, the perceptions of the same face with and without cosmetics to see that relatively simple artificially created exaggerations can be quite effective in eliciting heightened positive responses that may be consequential.

In the late 2000s, Fisher re-purposed the term "[::capitalist realism::](https://en.wikipedia.org/wiki/Capitalist_realism)" to describe "the widespread sense that not only is capitalism the only viable political and economic system, but also that it is now impossible even to imagine a coherent alternative to it".[::[18]::](https://en.wikipedia.org/wiki/Mark_Fisher#cite_note-18) He expanded on the concept in his 2009 book *Capitalist Realism: Is There No Alternative?*,[::[19]::](https://en.wikipedia.org/wiki/Mark_Fisher#cite_note-:0-19) arguing that the term best describes the ideological situation since the fall of the [::Soviet Union::](https://en.wikipedia.org/wiki/Soviet_Union), in which the logics of capitalism have come to delineate the limits of political and social life, with significant effects on education, mental illness, pop culture, and methods of resistance.[::[19]::](https://en.wikipedia.org/wiki/Mark_Fisher#cite_note-:0-19) The result is a situation in which it is "easier to imagine an end to the world than an end to capitalism."[::[20]::](https://en.wikipedia.org/wiki/Mark_Fisher#cite_note-:6-20) Fisher writes:[::[21]::](https://en.wikipedia.org/wiki/Mark_Fisher#cite_note-21)

> Capitalist realism as I understand it ... is more like a pervasive atmosphere, conditioning not only the production of culture but also the regulation of work and education, and acting as a kind of invisible barrier constraining thought and action.



Capitalists maintain their power not through violence or force, but by creating a pervasive sense that the Capitalist system is all there is. They maintain this view by dominating most social and cultural institutions. Fisher proposes that within a capitalist framework there is no space to conceive of alternative forms of social structures, adding that younger generations are not even concerned with recognizing alternatives. He proposes that the 2008 financial crysis compounded this position; rather than catalyzing a desire to seek alternatives for the existing model, the response to the crisis reinforced the notion that modifications must be made within the existing system. Fisher argues that capitalist realism has propagated a 'business ontology’ which concludes that everything should be run as a business including education and healthcare.

## **Development**

While video games can’t directly kill you, superstimuli can contribute to your descent.

The activity is incidental, so no hard feelings, right?

People's instincts for food, sex, and protecting their territory were made for life on the savannah 10,000 years ago, not for life in a high-tech world with a lot of people. Our instincts haven't had time to catch up with how quickly things change in the modern world.

### Superstimuli as coping mechanisms

Prisons: if you had no super stimuli, would the life of prison inmates would be the same? This is a question without a proper answer as I do not have the date outlining the current state of an inmate’s brain distortion due to subhuman prison conditions, but I do know that the United States prison system is pretty fucked.

### Superstimuli in tech

Sometimes when I stare into my phone, it’s an out of body experience. Heaven and earth fall away, I forget where I am, and I feel surprised when I look up and realize I am still in the world

This person, zero hp lovecraft, he isn’t me, he’s a ghost I carry around, but he lives in here, in the interior space of the phone, the screen, the data. Once in a while he steps out into real space, but it’s a lossy copy, you understand? A projection

Miguel Serrano opined, in his memoirs, that everything that had happened to him had not happened to him, but to an alternate version of him. I think about that every so often.

You might say he is an Avatar.

There is an idea of a Zero HP Lovecraft; some kind of abstraction. But there is no real me: only an entity, something illusory.

![[Image_jpeg_preview.jpeg]]

- Your urge to check WhatsApp, Instagram, Facebook, TikTok and other future platforms.
- Think about it: how can a product become so addictive after X hours of use?

## Stuperstimuli and beauty

A growing body of evidence suggests the way women's beauty ideals are constructed and prescribed varies with such factors as socioeconomic status, gender role stereotyping and sexual orientation…

By contrast, research on what constitutes an attractive male body has not received the same level of attention despite evidence that both women and men hold strong beliefs about male attractiveness.

## We project what we want to see

X reaches to a point where he does not know who he is anymore.

The same case can be made for life enhancement and the merge with AI.

There were always outliers that became like this throughout history, but now the general masses have succumbed to this condition. There is no longer a rite of passage into adulthood, you can be sheltered and live comfortably. This is de-evolution. Everyone has a dandy-ol time being a degenerate well into their 50s. Constant entertainment, pre-cooked meals and pornography have robbed us of our man-hood.
...
Resisting any temptation takes conscious expenditure of [::an exhaustible supply of mental energy::](http://www.stanford.edu/group/SITE/archive/SITE_2006/Web%20Session%207/Ozdenoren_Paper.pdf).  It is not in fact *true* that we can "just say no" - not *just* say no, without cost to ourselves. Even humans who won the birth lottery for willpower or foresightfulness still pay a price to resist temptation.  The price is just more easily paid.

## **Ending**

Ulysses didn't get past the beautiful but dangerous Sirens by sheer force of will. Rather, he was aware of his flaws and resolved to sail past the Sirens. He tied himself to the mast of his ship.

Should we make new people? Should we force people to remain alive?

There is a chance that cutting-edge entertainment technology may cause widespread sterility, wireheading, population decline, and extinction. Given the great heritability of media consumption habits, any such impact would lead to a quick human adaptability, indicating that extinction is nearly unthinkable without an instantaneous collapse or, maybe, exponentially growing addiction.

I sometimes feel that a combination of new punk tech and hunter-gatherer tech could fit our needs. I imagine being like Donatello from ninja turtles, wearing his apparently rugged but so effective pieces of tech and employing them only during the times of need.
...
Or might, like the  [Flynn effect](https://en.wikipedia.org/wiki/Flynn_effect)  and height, we already be experiencing a reversal due to the obesity crisis or other factors like mutation load and we have already seen ‘Peak Beauty’ (at least for the average person, of course CGI/ growing populations/ cosmetic tech implies that models & actors will continue their evolution into superstimuli)?
...
+ ## Questions to ask
    - [Is music a superstimulus?](https://www.reddit.com/r/musictheory/comments/t3dj0l/music_superstimulus/)
    - What is the role of super normal stimulus in habit formation?
    - Think about it: how can a product become so addictive after X hours of use?

*Integrate and delete*

[Zero HP Lovecraft 🦅🐍 on Twitter](https://twitter.com/0x49fa98/status/1540010084499087361?s=21&t=6lpj-rR6p8PmiU3AfWK7yg)
